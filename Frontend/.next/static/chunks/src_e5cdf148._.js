...
function DatePicker(param) {
    let { date, onDateChange, placeholder = "Pick a date", className, disabled } = param;
...
function repaymentSchedule(LOAN_AMOUNT, MONTHLY_RATE, LOAN_TERM, depositDate, option) {
    if (LOAN_TERM <= 0) throw new Error("Term must be greater than zero.");
    if (MONTHLY_RATE < 0 || MONTHLY_RATE > 25) throw new Error("Monthly rate must be between 0 and 1.");
    ...
    if (option === "high_payment_early") {
        ...
        for(let i = 1; i <= LOAN_TERM; i++){
            payment_data["int_weighted".concat(i)] = ints["w".concat(i)];
            payment_data["print_weighted".concat(i)] = prins["w".concat(i)];
        }
    ...
    for(let period = 1; period <= LOAN_TERM; period++){
        var _payment_data_;
        const int_w = (_payment_data_ = payment_data["int_weighted".concat(period)]) !== null && _payment_data_ !== void 0 ? _payment_data_ : 0;
        var _payment_data_1;
        const pr_w = (_payment_data_1 = payment_data["print_weighted".concat(period)]) !== null && _payment_data_1 !== void 0 ? _payment_data_1 : 0;
        payments["monthlyPayment".concat(period)] = round2(int_w + pr_w);
    }
    // ---------------------------
    // OSB Calculation
    // ---------------------------
    ...
    for(let period = 1; period <= LOAN_TERM; period++){
        ...
        for(let p = period + 1; p <= LOAN_TERM; p++){
            var _payment_data_2;
            remaining += (_payment_data_2 = payment_data["print_weighted".concat(p)]) !== null && _payment_data_2 !== void 0 ? _payment_data_2 : 0;
        }
        osbs["osb".concat(period)] = round2(remaining);
    }
    let total_interest = 0;
    for(let period = 1; period <= LOAN_TERM; period++){
        total_interest += payment_data["int_weighted".concat(period)];
    }
    ...
    const schedule = [];
    for(let period = 1; period <= LOAN_TERM; period++){
        var _payment_data_3, _payment_data_4, _payments_, _osbs_;
        schedule.push({
            period,
            monthlyPrincipal: (_payment_data_3 = payment_data["print_weighted".concat(period)]) !== null && _payment_data_3 !== void 0 ? _payment_data_3 : 0,
            monthlyInterest: (_payment_data_4 = payment_data["int_weighted".concat(period)]) !== null && _payment_data_4 !== void 0 ? _payment_data_4 : 0,
            monthlyPayment: (_payments_ = payments["monthlyPayment".concat(period)]) !== null && _payments_ !== void 0 ? _payments_ : 0,
            monthlyOSB: (_osbs_ = osbs["osb".concat(period)]) !== null && _osbs_ !== void 0 ? _osbs_ : 0,
...
function amortization(LOAN_AMOUNT, MONTHLY_RATE, LOAN_TERM) {
    let fixed_payment;
    if (MONTHLY_RATE === 0) {
    ...
    const weighted_interests = {};
    const weighted_principals = {};
    ...
    for(let period = 1; period <= LOAN_TERM; period++){
        ...
        weighted_interests["int_weighted".concat(period)] = round2(interest_payment);
        weighted_principals["print_weighted".concat(period)] = round2(principal_payment);
...
// Weighted Function
// ---------------------------
function weightedBy(total, total_weight, LOAN_TERM, ascending) {
    const m = {};
    for(let period = 1; period <= LOAN_TERM; period++){
        const weight = ascending ? period : LOAN_TERM - period + 1;
        m["w".concat(period)] = round2(total * weight / total_weight);
    }
    return m;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function LoanCalculator() {
    ...
    const [principal, setPrincipal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(500);
    ...
    const [rate, setRate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5);
    // Use a static date to avoid hydration mismatch
    const [depositDate, setDepositDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Date());
    ...
    const [calculateOption, setCalculateOption] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('equal_payment');
    const handleCalculate = ()=>{
        ...
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$loan$2d$calculations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["repaymentSchedule"])(principal, rate / 100, months, depositDateString, calculateOption);
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                children: language === 'km' ? "100 ".concat(t('form.curency')) : "100"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/loan-calculator.tsx",
                                                                lineNumber: 70,
                                                                columnNumber: 21
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                children: language === 'km' ? "10000 ".concat(t('form.curency')) : "$10000"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/loan-calculator.tsx",
                                                                lineNumber: 71,
                                                                columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                                ...
                                                                onValueChange: (value)=>setCalculateOption(value),
                                                                children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                                            children: repaymentData.schedule.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                            className: "text-center text-gray-900 dark:text-gray-100",
                                                                            children: entry.monthlyPrincipal
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/components/loan-calculator.tsx",
                                                                            lineNumber: 192,
                                                                            columnNumber: 29
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                            className: "text-center text-gray-900 dark:text-gray-100",
                                                                            children: entry.monthlyInterest
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/components/loan-calculator.tsx",
                                                                            lineNumber: 193,
                                                                            columnNumber: 29
...
_s(LoanCalculator, "RAxy1vCZIFQP6v27KL2RMZVh0dc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$translation$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
...
//# sourceMappingURL=src_e5cdf148._.js.map