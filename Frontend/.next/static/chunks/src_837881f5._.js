...
function calculateRepayment(principal, months, monthlyRatePercent, depositDate) {
    return generateRepaymentSchedule(principal, months, monthlyRatePercent, depositDate);
}
function generateRepaymentSchedule(principal, months, monthlyRatePercent, depositDate) {
    const schedule = [];
    ...
    for(let month = 1; month <= months; month++){
        ...
        schedule.push({
            month,
            monthlyPayment: "$".concat(finalMonthlyPayment.toFixed(2)),
...
(()=>{
    const e = new Error("Cannot find module '@/src/components/ui/date-picker'");
...
function LoanCalculator() {
    ...
    const [depositDate, setDepositDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Date()) // Nov 5, 2025
    ;
...
_s(LoanCalculator, "LWRKy+MUQ+NrKrI47XW4ZUjxEvE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$translation$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
...
//# sourceMappingURL=src_837881f5._.js.map